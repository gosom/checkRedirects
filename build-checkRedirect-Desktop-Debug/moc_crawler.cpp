...
#include "../checkRedirect/crawler.h"
...
static const char qt_meta_stringdata_Crawler[] = {
    "Crawler\0\0crawling_finished()\0int\0fname\0"
    "load_from_file(QString)\0start_crawl()\0"
...
void Crawler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->crawling_finished(); break;
        case 1: { int _r = _t->load_from_file((*reinterpret_cast< QString(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = _r; }  break;
        case 2: _t->start_crawl(); break;
...
const QMetaObject Crawler::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Crawler,
...
// SIGNAL 0
void Crawler::crawling_finished()
{
