...
#include "../checkRedirect/request.h"
...
static const char qt_meta_stringdata_Request[] = {
    "Request\0"
};
...
const QMetaObjectExtraData Request::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Request::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Request,
      qt_meta_data_Request, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &Request::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Request))
